...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        [
            ...
            new Goal("agent7", "Marseille", "Lyon", new DateTime(2024, 12, 25, 10, 40, 00), DateTime.Now),
        ...
        var algorithm = new DPAlgorithm(goals, cars);
        
        var coalitions = algorithm.Start();

        Console.WriteLine("====================== DP Alogrithm =================================");
        ...
        algorithm = new DPAlgorithm(goals, cars);
        
        coalitions = algorithm.Start();
        
        Console.WriteLine("====================== IP Alogrithm =================================");
        foreach (var coalition in coalitions)
        {
            Console.WriteLine("Coalition for car " + coalition[0].Car?.Name + ": ");
            foreach (var agent in coalition)
